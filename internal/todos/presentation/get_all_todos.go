...
func (s *TodosHandler) GetAllTodos(w http.ResponseWriter, r *http.Request) {
	var req todos_application.GetAllTodosRequest
	...
	common_presentation.JsonResponseWithStatus(w, http.StatusOK, common_domain.SuccessDataResult("todos_fetched_successfully", response))
}
