...
func (h *TenantsHandler) GetAllTenants(c *fiber.Ctx) error {
	...
	commonPresentation.JsonResponseWithStatus(c, fiber.StatusOK, commonDomain.SuccessDataResult("tenants_fetched_successfully", response))
	return nil
}
